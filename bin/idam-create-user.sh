...
rolesJson="${rolesJson}]"
curl -s -o /dev/null -XDELETE https://idam-api.demo.platform.hmcts.net/testing-support/accounts/$email

curl -s -o /dev/null -XPOST \
  https://idam-api.demo.platform.hmcts.net/testing-support/accounts \
